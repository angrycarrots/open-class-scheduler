...
('Morning Flow', 'Start your day with gentle yoga flow', 'A gentle morning yoga class focusing on stretching and breathing exercises. Perfect for beginners and those looking to start their day mindfully.', 'Michael', NOW() + INTERVAL '1 day', NOW() + INTERVAL '1 day' + INTERVAL '1 hour', 12.00, 0),
('Power Yoga', 'High-intensity yoga workout', 'An energetic vinyasa flow class that builds strength, flexibility, and endurance. Suitable for intermediate to advanced practitioners.', 'Michael', NOW() + INTERVAL '2 days', NOW() + INTERVAL '2 days' + INTERVAL '1.5 hours', 15.00, 0),
('Restorative Yoga', 'Deep relaxation and healing', 'A slow-paced class using props to support the body in passive poses. Focuses on deep relaxation and stress relief.', 'Michael', NOW() + INTERVAL '3 days', NOW() + INTERVAL '3 days' + INTERVAL '1 hour', 10.00, 0),
